...
$filtro_name = ((isset($_REQUEST['f']) and $_REQUEST['f']!="") ? " AND titulo LIKE '%".$_REQUEST['f']."%' " : "" );
$regs = 18;
$inicio = ($pagina*$regs);
$elements = fotosController::getListAction($regs, $filtro_album.$filtro_name." AND estado=1 ORDER BY id_file DESC LIMIT ".$inicio.", ".$regs);
