		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="text-muted">Resumen general</span></div>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading"><span class="text-muted"><?php echo strTranslate("Reports");?></span></div>
					<div class="panel-body">
						<dl class="dl-horizontal">
							<dt>Accesos</dt>
