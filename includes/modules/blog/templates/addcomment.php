...
function addForoComment($id_tema){
	...
	<form id="coment-form" name="coment-form" action="" method="post" role="form">
		...
		<div class="alert-message alert alert-danger" id="alertas-foro"><?php echo strTranslate("Required_field");?></div>
		<br />
		<button class="btn btn-primary" type="submit" id="coment-submit" name="coment-submit"><?php echo strTranslate("Send");?></button>	
	</form>
	<?php
}
?>