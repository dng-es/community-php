...
function footerMail($username){
	...
	$user_foto = ($user_data[0]['foto']!="" ? $user_data[0]['foto'] : DEFAULT_IMG_PROFILE);
	$footer_final='
	<table>
		<tr>
			<td valign="top"><img src="'.$ini_conf['SiteUrl'].'/images/usuarios/'.$user_foto.'" width="50px" height="50px" style="width:50px;height:50px" /></td>
