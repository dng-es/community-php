...
MySQL - 5.5.38-0ubuntu0.12.04.1 : Database - comunidad
*********************************************************************
*/
...
insert  into `galeria_fotos`(`id_file`,`id_promocion`,`tipo_foto`,`titulo`,`name_file`,`user_add`,`date_foto`,`canal`,`estado`,`fotos_puntos`,`seleccion_reto`,`formacion`,`id_album`) values (1,0,'','test1','1410340463_apr-14-relax-cal-1600x1050.png','admin','2014-09-10 11:14:23','comercial',1,0,0,0,1);
...
/*Table structure for table `premios_dia` */

DROP TABLE IF EXISTS `premios_dia`;

CREATE TABLE `premios_dia` (
  `tipo` varchar(100) NOT NULL,
  `cuerpo` longtext NOT NULL,
  `fondo` int(2) NOT NULL DEFAULT '1',
  `canal_premio` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`tipo`,`canal_premio`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `premios_dia` */

insert  into `premios_dia`(`tipo`,`cuerpo`,`fondo`,`canal_premio`) values ('texto','<span >y el d&iacute;a de los communities ha llegado!!! <span style=\"color: rgb(255, 102, 0);\"><span style=\"font-size: 16px;\">Hoy ANAYS y Alicia Sertel conocer&aacute;n los secretos de la comunidad</span></span>, subiremos fotos y v&iacute;deos...<span style=\"color: rgb(255, 102, 0);\"><span style=\"font-size: 16px;\">te lo vas a perder??</span></span></span>',2,'comercial'),('texto','Nuevos contenidos y nuevos foros interesantes. No dejes de visitar la secci&oacute;n <strong><span style=\"color: rgb(255, 102, 0);\">&quot;la oveja lo sabe&quot;</span> </strong>y<span style=\"color: rgb(255, 102, 0);\"> </span><strong><span style=\"color: rgb(255, 102, 0);\">&quot;foro expr&eacute;sate&quot;.</span></strong><br />\r\n<br />\r\n<strong>&iexcl;&iexcl;Participa, comparte y aprende!!</strong>',1,'gerente');
...
insert  into `users`(`username`,`nick`,`user_password`,`email`,`name`,`surname`,`date_add`,`registered`,`confirmed`,`disabled`,`date_disabled`,`canal`,`empresa`,`perfil`,`foto`,`puntos`,`participaciones`,`user_comentarios`,`user_date`,`telefono`,`last_access`) values ('admin','AdminII','1234','dnoguera@imagar.com','Administrador',' Community','2014-07-16 14:43:05',1,1,0,'1970-01-01 00:00:00','admin','','admin','',18,9,'C/algo3',NULL,'','2014-09-15 09:52:11'),('david','DNG','1234','dnoguera@imagar.com','David','Noguera','2014-07-16 14:43:08',1,1,0,'1970-01-01 00:00:00','comercial','','usuario','',4,0,'',NULL,'','2014-09-11 12:56:49');
...
insert  into `users_connected`(`username`,`connection_canal`,`connection_time`) values ('admin','admin','2014-09-15 10:09:22');
...
insert  into `users_tiendas`(`cod_tienda`,`nombre_tienda`,`regional_tienda`,`responsable_tienda`,`tipo_tienda`) values ('0001','CENTRAL','','','Tienda propia'),('0002','TIENDAS PROPIAS','','','Tienda propia'),('0003','FRANQUICIAS','','','Franquicia'),('2ACB','ALAIN AFFLELOU OPTICO CIUDAD DE BARCELONA','05428323R','X6821471Q','Tienda propia'),('2ACC','C.C. CARREFOUR ALCALÁ DE HENARES','05428323R','53438584Q','Tienda propia'),('2ACH','ALAIN AFFLELOU OPTICO ALCALA DE HENARES','05428323R','47217645W','Tienda propia'),('2AMO','C.C. CARREFOUR ALFONSO MOLINA','72444297R','32831207H','Tienda propia'),('2APU','C.C. CARREFOUR PUERTA DE ALICANTE','08932984Z','21489816L','Tienda propia'),('2ASC','C.C. AS CANCELAS','72444297R','35467255J','Tienda propia'),('2ASJ','C.C. CARREFOUR SAN JUAN','08932984Z','52773971B','Tienda propia'),('2AZN','C.C. CARREFOUR AZNALFARACHE','75749272Z','79203590P','Tienda propia'),('2BDI','C.C. DIAGONAL MAR','40331392H','43535447N','Tienda propia'),('2BGL','C.C. CARREFOUR LAS GLORIAS','40331392H','46616589M','Tienda propia'),('2BIC','ALAIN AFFLELOU OPTICO BILBAO','72444297R','44974510B','Tienda propia'),('2BMQ','C.C. CARREFOUR LA MAQUINISTA','40331392H','43540540E','Tienda propia'),('2BMT','ALAIN AFFLELOU OPTICO MUNTANER','40331392H','37389069Q','Tienda propia'),('2BON','C.C. Y DE OCIO BONAIRE','08932984Z','25419519B','Tienda propia'),('2BSA','ALAIN AFFLELOU OPTICO SAN ANTONIO','40331392H','40998311Y','Tienda propia'),('2BSN','ALAIN AFFLELOU OPTICO SANTS','40331392H','X9402547D','Tienda propia'),('2CAL','ALAIN AFFLELOU OPTICO GONDOMAR','75749272Z','75166474J','Tienda propia'),('2CAM','C.C. CARREFOUR CAMAS','75749272Z','28491619R','Tienda propia'),('2CCO','ALAIN AFFLELOU OPTICO COLUMELA  ','75749272Z','74681804E','Tienda propia'),('2DHE','C.C. CARREFOUR DOS HERMANAS','75749272Z','28496764V','Tienda propia'),('2E01','C.C. CARREFOUR SAN FERNANDO','05428323R','51981853J','Tienda propia'),('2E02','C.C. CARREFOUR SAN SEBASTIÁN DE LOS REYES','05428323R','07232928A','Tienda propia'),('2E04','ALAIN AFFLELOU OPTICO PLAZA CATALUÑA','43054400X','38431511Y','Tienda propia'),('2E05','ALAIN AFFLELOU OPTICO GRAN VIA','05428323R','46871216E','Tienda propia'),('2E06','C.C. THE STYLE OUTLETS ','05428323R','53005933H','Tienda propia'),('2EAL','C.C. CARREFOUR EL ALISAL','72444297R','70243182D','Tienda propia'),('2ELS','C.C. EL SALER','08932984Z','20845579N','Tienda propia'),('2FIG','C.C. CARREFOUR NOU CENTRE','40331392H','47830177K','Tienda propia'),('2GET','ALAIN AFFLELOU OPTICO GETAFE','08932984Z','47451905F','Tienda propia'),('2GIR','ALAIN AFFLELOU OPTICO GIRONA','40331392H','44015567F','Tienda propia'),('2GMA','ALAIN AFFLELOU OPTICO GANDIA','08932984Z','06249126A','Tienda propia'),('2GRI','ALAIN AFFLELOU OPTICO GENERAL RICARDOS','05428323R','02261258J','Tienda propia'),('2HAB','C.C. HABANERAS','08932984Z','48458241R','Tienda propia'),('2HCA','ALAIN AFFLELOU OPTICO HUESCA','72444297R','44266404Y','Tienda propia'),('2HUH','C.C. HOLEA HUELVA','75749272Z','74664167A','Tienda propia'),('2IAZ','C.C. ISLAZUL ','05428323R','06260876T','Tienda propia'),('2JVC','ALAIN AFFLELOU OPTICO JAEN','75749272Z','26975548K','Tienda propia'),('2LBR','C.C. LOS BARRIOS','75749272Z','76430658W','Tienda propia'),('2LCN','C.C. CARREFOUR LUCENA','75749272Z','34029772F','Tienda propia'),('2LER','ALAIN AFFLELOU OPTICO LÉRIDA ','40331392H','73209776V','Tienda propia'),('2LHY','ALAIN AFFLELOU OPTICO LOPEZ DE HOYOS','05428323R','53048554C','Tienda propia'),('2LLA','C.C. CARREFOUR LOS LLANOS','08932984Z','44394121G','Tienda propia'),('2LSI','C.C. CARREFOUR LA SIERRA','75749272Z','45736314D','Tienda propia'),('2MAB','ALAIN AFFLELOU OPTICO ALCOBENDAS','05428323R','50893472S','Tienda propia'),('2MAC','C.C. CARREFOUR MACARENA','75749272Z','74680286E','Tienda propia'),('2MAN','C.C. EL MANAR','08932984Z','48311242H','Tienda propia'),('2MAR','C.C. LA MARINEDA CITY','72444297R','32814944Q','Tienda propia'),('2MCA','ALAIN AFFLELOU OPTICO CALLE ALCALÁ','05428323R','11843235Y','Tienda propia'),('2MCF','ALAIN AFFLELOU OPTICO FUENCARRAL','05428323R','11830679P','Tienda propia'),('2MCO','ALAIN AFFLELOU OPTICO CALLE ORENSE','08932984Z','47219955N','Tienda propia'),('2MMA','ALAIN AFFLELOU OPTICO MOSTOLES 2','08932984Z','20253016K','Tienda propia'),('2MMC','C.C. CARREFOUR MOSTOLES','08932984Z','52872016F','Tienda propia'),('2MON','C.C. CARREFOUR MONTEQUINTO','75749272Z','48858971W','Tienda propia'),('2NVI','C.C. CARREFOUR LAS CAÑAS','72444297R','16616384B','Tienda propia'),('2OGS','ALAIN AFFLELOU OPTICO ORTEGA Y GASSET','05428323R','50462596K','Tienda propia'),('2PAC','ALAIN AFFLELOU OPTICO ACACIAS','05428323R','50221047H','Tienda propia'),('2PCC','ALAIN AFFLELOU OPTICO MALLORCA','40331392H','Y0099338S','Tienda propia'),('2PEC','C.C. CARREFOUR PEÑACASTILLO','72444297R','71130262W','Tienda propia'),('2PLB','C.C. LA BALLENA','75749272Z','44304802V','Tienda propia'),('2PLC','ALAIN AFFLELOU OPTICO PALENCIA','05428323R','12773086J','Tienda propia'),('2PMP','C.C. SAN FERNANDO MASPALOMAS','75749272Z','44304802V','Tienda propia'),('2PZE','ALAIN AFFLELOU OPTICO VALENCIA','08932984Z','75415843Q','Tienda propia'),('2RIO','ALAIN AFFLELOU OPTICO LOGROÑO','72444297R','45683862C','Tienda propia'),('2SAB','C.C. ALCAMPO SANT ADRIÀ','40331392H','46801958V','Tienda propia'),('2SCB','ALAIN AFFLELOU OPTICO SANTANDER','72444297R','76576321Y','Tienda propia'),('2SCO','ALAIN AFFLELOU OPTICO SANTIAGO','72444297R','44819419D','Tienda propia'),('2SGO','ALAIN AFFLELOU OPTICO SORIA','72444297R','01181001C','Tienda propia'),('2SNP','C.C. NERVIÓN PLAZA','75749272Z','74664935N','Tienda propia'),('2SPA','C.C. CARREFOUR SAN PABLO','75749272Z','31724624B','Tienda propia'),('2TAF','C.C. LOS ALFARES. ALAIN AFFLELOU OPTICO TALAVERA','08932984Z','04208476M','Tienda propia'),('2TGN','C.C. CARREFOUR TARRAGONA','40331392H','44178315F','Tienda propia'),('2TOL','C.C. CARREFOUR TORRELAVEGA','72444297R','12756660D','Tienda propia'),('2TRE','ALAIN AFFLELOU OPTICO REUS','40331392H','X7339226H','Tienda propia'),('2TRS','ALAIN AFFLELOU OPTICO TOLEDO','08932984Z','06264377M','Tienda propia'),('2TUD','C.C. CARREFOUR TUDELA','72444297R','78752506T','Tienda propia'),('2VGA','C.C. LA GAVIA','05428323R','01925639X','Tienda propia'),('2VIL','ALAIN AFFLELOU OPTICO VILANOVA','40331392H','47631660V','Tienda propia'),('2VNO','C.C. NUEVO CENTRO','08932984Z','53361825P','Tienda propia'),('2VPA','ALAIN AFFLELOU OPTICO PASCUAL Y GENIS','08932984Z','48527303V','Tienda propia'),('2ZAU','C.C. CARREFOUR AUGUSTA','72444297R','17749456B','Tienda propia'),('2ZHI','C.C. CARREFOUR ZAHIRA','75749272Z','30822560F','Tienda propia'),('2ZMZ','C.C. CARREFOUR ACTUR','72444297R','29129822T','Tienda propia'),('2ZPV','C.C. PUERTO VENECIA','72444297R','25196976Q','Tienda propia'),('FAAA','ALAIN AFFLELOU OPTICO DENIA','77000910S','28992478N','Franquicia'),('FAAJ','ALAIN AFFLELOU OPTICO SAN JAVIER','77000910S','27432487L','Franquicia'),('FAAK','ALAIN AFFLELOU OPTICO CUENCA','47488915X','04604104X','Franquicia'),('FAAM','ALAIN AFFLELOU OPTICO PILAR','77000910S','77504931Z','Franquicia'),('FAAN','ALAIN AFFLELOU OPTICO XATIVA','77000910S','20415012M','Franquicia'),('FAAX','C.C. CARREFOUR GRANVIA L`HOSPITALET','50217668C','46629713L','Franquicia'),('FAAY','C.C. CARREFOUR EL PRAT','50217668C','46629713L','Franquicia'),('FABB','C. C. CARREFOUR PAMPLONA','45673652E','33906146Y','Franquicia'),('FABC','C.C. CARREFOUR EL BULEVAR','45673652E','6578146P','Franquicia'),('FABD','C.C. CARREFOUR MÉRIDA','47488915X','76256778W','Franquicia'),('FABE','C.C. CARREFOUR EL PASEO','X2590728P','25677461P','Franquicia'),('FABF','ALAIN AFFLELOU OPTICO ROTA','X2590728P','25677461P','Franquicia'),('FABG','C.C. CARREFOUR PARQUE ASTUR','45673652E','46898510S','Franquicia'),('FABH','C.C. CARREFOUR MERIDIANO','02877115E','21514830D','Franquicia'),('FABI','C.C. CARREFOUR SANTA CRUZ (AÑAZA)','02877115E','21514830D','Franquicia'),('FABP','C.C. CARREFOUR RINCÓN DE LA VICTORIA','X2590728P','74659280S','Franquicia'),('FABQ','C.C. CARREFOUR GRAN SUR','X2590728P','53082678N','Franquicia'),('FABR','C.C. CARREFOUR SAN SEBASTIÁN','45673652E','08987354N','Franquicia'),('FABU','ALAIN AFFLELOU OPTICO ROQUETAS ','X2590728P','53707884D','Franquicia'),('FABW','C.C. CARREFOUR ALMERÍA','X2590728P','75728943V','Franquicia'),('FABZ','C.C. CARREFOUR CARTAYA','02542552V','44214767G','Franquicia'),('FACH','C.C. CARREFOUR AZABACHE','45673652E','50189054H','Franquicia'),('FACN','C.C. CARREFOUR PARQUESOL VALLADOLID','05428323R','06566553F','Tienda propia'),('FACO','C.C. CARREFOUR VALLADOLID 2','05428323R','03471171B','Tienda propia'),('FACP','C.C. CARREFOUR LOS PRADOS','45673652E','50189054H','Franquicia'),('FADA','ALAIN AFFLELOU OPTICO MOLINA DE SEGURA','X2590728P','48432652B','Franquicia'),('FADC','ALAIN AFFLELOU OPTICO URBIETA','45673652E','08987354N','Franquicia'),('FADE','C.C. ESPACIO MEDITERRANEO','77000910S','77504931Z','Franquicia'),('FADG','ALAIN AFFLELOU OPTICO SEGOVIA','45673652E','6578146P','Franquicia'),('FADI','C.C. LA ROSALEDA','X2590728P','44577341Y','Franquicia'),('FADJ','ALAIN AFFLELOU OPTICO LA RODA','47488915X','7557301F','Franquicia'),('FADP','ALAIN AFFLELOU OPTICO  ALBACETE','47488915X','52763273P','Franquicia'),('FADQ','ALAIN AFFLELOU OPTICO TORREJON','47488915X','08950374Q','Franquicia'),('FADU','ALAIN AFFLELOU OPTICO VALDEMORO','02542552V','7484995J','Franquicia'),('FADW','ALAIN AFFLELOU OPTICO CARLET','77000910S','73774883Z','Franquicia'),('FADX','ALAIN AFFLELOU OPTICO AGUILAS','X2590728P','74437421Z','Franquicia'),('FAEA','C.C. CARREFOUR CÁCERES','47488915X','53106157P','Franquicia'),('FAEI','C.C. VILAMARINA','50217668C','46629713L','Franquicia'),('FAEM','ALAIN AFFLELOU OPTICO ELCHE','77000910S','48319346T','Franquicia'),('FAEN','ALAIN AFFLELOU OPTICO LEGANES','47488915X','02642616P','Franquicia'),('FAEQ','ALAIN AFFLELOU OPTICO JUMILLA','X2590728P','77509589A','Franquicia'),('FAER','ALAIN AFFLELOU OPTICO VALLECAS','47488915X','52184332T','Franquicia'),('FAES','ALAIN AFFLELOU OPTICO NARÓN','53110268W','32666953F','Franquicia'),('FAEU','ALAIN AFFLELOU OPTICO PINTO ','02542552V','03819575B','Franquicia'),('FAFA','ALAIN AFFLEOU OPTICO EL EJIDO','X2590728P','53707884D','Franquicia'),('FAFB','C.C. Y DE OCIO EL ROSAL DE PONFERRADA','53110268W','10077244R','Franquicia'),('FAFC','C.C.MODOO OVIEDO','45673652E','50189054H','Franquicia'),('FAFE','C.C. CARREFOUR KINEPOLIS PULIANAS','X2590728P','75728943V','Franquicia'),('FAFH','ALAIN AFFLELOU OPTICO PAMPLONA CALLE','45673652E','33906146Y','Franquicia'),('FAFI','ALAIN AFFLELOU OPTICO MARÍN','53110268W','52491888T','Franquicia'),('FAFN','ALAIN AFFLELOU OPTICO MAJADAHONDA','02542552V','50050631D','Franquicia'),('FAFQ','C.C. AREA SUR, AREA 7','X2590728P','25677461P','Franquicia'),('FAFT','ALAIN AFFLELOU OPTICO BOUZAS','53110268W','36080623V','Franquicia'),('FAFU','ALAIN AFFLELOU OPTICO CIEMPOZUELOS','47488915X','07481335X','Franquicia'),('FAFV','ALAIN AFFLELOU OPTICO SANTA POLA','77000910S','22953533Q','Franquicia'),('FAFY','ALAIN AFFLELOU OPTICO SAN FERNANDO','47488915X','08950374Q','Franquicia'),('FAFZ','ALAIN AFFLELOU OPTICO RIVAS','02542552V','50968386H','Franquicia'),('FAGA','ALAIN AFFLELOU OPTICO BOIRO','53110268W','33230283K','Franquicia'),('FAGB','ALAIN AFFLELOU OPTICO VIGO','53110268W','32672475D','Franquicia'),('FAGD','ALAIN AFFLELOU OPTICO ARGANDA','02542552V','03819575B','Franquicia'),('FAGF','ALAIN AFFLELOU OPTICO PARLA','47488915X','08950374Q','Franquicia'),('FAGI','ALAIN AFFLELOU OPTICO BURGOS','45673652E','44148852F','Franquicia'),('FAGK','C.C. CARREFOUR PETRER','77000910S','74193753P','Franquicia'),('FAGN','ALAIN AFFLELOU OPTICO PONTEAREAS','53110268W','22736961N','Franquicia'),('FAGO','C.C. ALCAMPO LINARES','X2590728P','04604104X','Franquicia'),('FAGQ','ALAIN AFFLELOU OPTICO ALCOY','77000910S','22953533Q','Franquicia'),('FAGR','ALAIN AFFLELOU OPTICO CEE','53110268W','44821158T','Franquicia'),('FAGS','ALAIN AFFLELOU OPTICO BURELA','53110268W','33999278B','Franquicia'),('FAGV','ALAIN AFFLELOU OPTICO IRÚN','45673652E','08987354N','Franquicia'),('FAGW','C.C. PORTAL DE LA MARINA','77000910S','28992478N','Franquicia'),('FAGY','ALAIN AFFLELOU OPTICO FOZ','53110268W','77596096F','Franquicia'),('FAHA','ALAIN AFFLELOU OPTICO NOVELDA','77000910S','40995469B','Franquicia'),('FAHB','ALAIN AFFLELOU OPTICO ALCAZAR DE SAN JUAN','47488915X','06262442W','Franquicia'),('FAHC','ALAIN AFFLELOU OPTICO CALAHORRA','45673652E','16529445N','Franquicia'),('FAHE','C.C. CARREFOUR VINAROZ','50217668C','44754338H','Franquicia'),('FAHF','ALAIN AFFLELOU OPTICO CARAVACA','X2590728P','22471502L','Franquicia'),('FAHG','ALAIN AFFLELOU OPTICO CANGAS DEL MORRAZO','53110268W','22736961N','Franquicia'),('FAHH','ALAIN AFFLLEOU OPTICO MERIDA','47488915X','76256778W','Franquicia'),('FAHI','ALAIN AFFLELOU OPTICO ALICANTE','77000910S','48349740Z','Franquicia'),('FAHO','C COMERCIAL Y DE OCIO MADRID SUR','47488915X','52184332T','Franquicia'),('FAHR','ALAIN AFFLELOU OPTICO VILLAGARCIA AROSA','53110268W','32666953F','Franquicia'),('FAHU','ALAIN AFFLELOU SAN VICENTE DEL RASPEIG','77000910S','48319346T','Franquicia'),('FAHV','ALAIN AFFLELOU OPTICO ARTEIXO','53110268W','32811534X','Franquicia'),('FAHY','ALAIN AFFLELOU OPTICO TORRE PACHECO','77000910S','27432487L','Franquicia'),('FAIA','ALAIN AFFLELOU OPTICO PADRON','53110268W','33282234S','Franquicia'),('FAIB','ALAIN AFFLELOU OPTICO CARTAGENA','77000910S','77504931Z','Franquicia'),('FAIC','ALAIN AFFLELOU OPTICO ARANJUEZ','02542552V','03819575B','Franquicia'),('FAIE','ALAIN AFFLELOU OPTICO INCA','50217668C','01934167M','Franquicia'),('FAIR','C.C. PONTEVELLA','53110268W','46240155N','Franquicia'),('FAIS','ALAIN AFFLELOU OPTICO VILLALBA','53110268W','44829780C','Franquicia'),('FAIU','ALAIN AFFLELOU OPTICO LALIN','53110268W','44836847A','Franquicia'),('FAIV','ALAIN AFFLELOU OPTICO BERTAMIRANS','53110268W','52435530S','Franquicia'),('FAIX','ALAIN AFFLELOU OPTICO AVILES','45673652E','46898510S','Franquicia'),('FAJA','ALAIN AFFLELOU OPTICO MONFORTE DE LEMOS','53110268W','36131102B','Franquicia'),('FAJF','C.C. CARREFOUR BADAJOZ','47488915X','53106157P','Franquicia'),('FAJG','C.C. CARREFOUR LA GRANADILLA','47488915X','53106157P','Franquicia'),('FAJP','C.C. CARREFOUR TRAVESÍA','53110268W','32666953F','Franquicia'),('FAJQ','C.C. CARREFOUR PONTEVEDRA','53110268W','32666953F','Franquicia'),('FAJR','ALAIN AFFLELOU OPTICO TORTOSA','50217668C','44754338H','Franquicia'),('FAJT','C.C. CARREFOUR ERANDIO','45673652E','39175190A','Franquicia'),('FAJU','C.C. CARREFOUR SESTAO','45673652E','39175190A','Franquicia'),('FAJW','ALAIN AFFLELOU OPTICO VIC','50217668C','73774883Z','Franquicia'),('FAJX','C.C. CARREFOUR SALAMANCA','02542552V','2896353D','Franquicia'),('FAJY','ALAIN AFFLELOU OPTICO SALAMANCA 2','02542552V','2896353D','Franquicia'),('FAJZ','C.C. EL VENTANAL DE LA SIERRA','02542552V','2896353D','Franquicia'),('FAKB','ALAIN AFFLELOU OPTICO GIJÓN (PRINCIPE DE ASTURIAS)','45673652E','50189054H','Franquicia'),('FAKF','C.C. ARENA MULTIESPACIO','77000910S','23016549N','Franquicia'),('FAKG','C.C. CARREFOUR LUGO','53110268W','44829780C','Franquicia'),('FAKH','C.C. CAUDALIA','45673652E','44830060R','Franquicia'),('FAKI','C.C. LOS VALLES','02542552V','07470208S','Franquicia'),('FAKJ','C.C. ALCAMPO PARQUE ALCORCON','02542552V','20253813J','Franquicia'),('FAKK','ALAIN AFFLELOU OPTICO FUENLABRADA','02542552V','20253813J','Franquicia'),('FAKL','C.C. CARREFOUR CIUDAD DE LA IMAGEN','02542552V','20253813J','Franquicia'),('FAKN','ALAIN AFFLELOU OPTICO MELILLA','02542552V','45278536T','Franquicia'),('FAKO','C.C. LLOBREGAT CENTRE','50217668C','46629713L','Franquicia'),('FAKP','C.C. CARREFOUR MANRESA','50217668C','46629713L','Franquicia'),('FAKQ','C.C. CARREFOUR TERRASSA','50217668C','46629713L','Franquicia'),('FAKT','ALAIN AFFLELOU OPTICO GRAN CAPITAN','X2590728P','44279491Y','Franquicia'),('FAKU','ALAIN AFFLELOU OPTICO GUADALAJARA','47488915X','51371080M','Franquicia'),('FAKV','C.C. CARREFOUR CASTELLÓN','77000910S','71218533E','Franquicia'),('FAKW','ALAIN AFFLELOU OPTICO ALZIRA','77000910S','73774883Z','Franquicia'),('FAKX','ALAIN AFFLELOU OPTICO GIJÓN','45673652E','50189054H','Franquicia'),('FAKZ','ALAIN AFFLELOU OPTICO LOS ROSALES','53110268W','32811534X','Franquicia'),('FALB','ALAIN AFFLELOU OPTICO VITORIA','45673652E','X7339302w','Franquicia'),('FALC','ALAIN AFFLELOU OPTICO ALCORCON','47488915X','02642616P','Franquicia'),('FALD','ALAIN AFFLELOU OPTICO DON BENITO','47488915X','76258529M','Franquicia'),('FALE','ALAIN AFFLELOU OPTICO YECLA','X2590728P','29070940K','Franquicia'),('FALG','ALAIN AFFLELOU OPTICO PTO SAGUNTO','77000910S','44795515W','Franquicia'),('FALI','ALAIN AFFLELOU OPTICO ORDES','53110268W','787943312S','Franquicia'),('FALJ','ALAIN AFFLELOU OPTICO MONTIJO','47488915X','80073460H','Franquicia'),('FALL','C.C. PLENILUNIO','47488915X','04213054Y','Franquicia'),('FALM','C.C. L` ANEC BLAU','50217668C','24367577C','Franquicia'),('FALN','C.C. CARREFOUR COSTA SOL','X2590728P','44577341Y','Franquicia'),('FALQ','C.C. CARREFOUR ALCOBENDAS','47488915X','00693978E','Franquicia'),('FALS','ALAIN AFFLELOU OPTICO SANT BOI','50217668C','52147505L','Franquicia'),('FALV','C.C. CARREFOUR LAS ROSAS','47488915X','00693978E','Franquicia'),('FALX','ALAIN AFFLELOU OPTICO SADA','53110268W','32811534X','Franquicia'),('FALY','ALAIN AFFLELOU OPTICO HORTALEZA','02542552V','01934167M','Franquicia'),('FAMA','ALAIN AFFLELOU OPTICO PUERTOLLANO','47488915X','05915347T','Franquicia'),('FAMB',' ALAIN AFFLELOU OPTICO MARCELO USERA 2','47488915X','52184332T','Franquicia'),('FAMD','C.C. ALCAMPO FERROL','53110268W','32666953F','Franquicia'),('FAMH','ALAIN AAFFLELOU OPTICO LUGO','53110268W','44829780C','Franquicia'),('FAMJ','ALAIN AFFLELOU OPTICO OLIVA','77000910S','28992478N','Franquicia'),('FAMQ','ALAIN AFFLELOU OPTICO RUBÍ','50217668C','46629713L','Franquicia'),('FAMR','C.C. MONTIGALÁ','50217668C','39183419K','Franquicia'),('FAMS','C.C. EL OSITO','77000910S','52659505Q','Franquicia'),('FAMT','ALAIN AFFLELOU OPTICO CASTRO URDIALES','45673652E','22736961N','Franquicia'),('FAMU','C.C. BILBONDO','45673652E','78891503P','Franquicia'),('FAMV','ALAIN AFFLELOU OPTICO LA FUENSANTA','47488915X','50874245Q','Franquicia'),('FAMY','C.C. MADRID XANADÚ','02542552V','X2217552F','Franquicia'),('FAMZ','C.C. NUEVA CONDOMINA','X2590728P','5611392F','Franquicia'),('FANA','ALAIN AFFLELOU OPTICO ZAMORA','45673652E','08987354N','Franquicia'),('FANB','ALAIN AFFLELOU OPTICO GAVÀ','50217668C','46655398J','Franquicia'),('FANC','ALAIN AFFLELOU OPTICO MOLLET','50217668C','52147505L','Franquicia'),('FAND','ALAIN AFFLELOU OPTICO BRAVO MURILLO','02542552V','2532298K','Franquicia'),('FANE','C.C. PLAZA NUEVA','47488915X','53402020E','Franquicia'),('FANF','ALAIN AFFLELOU OPTICO GRANOLLERS','50217668C','53062298X','Franquicia'),('FANG','ALAIN AFFLELOU OPTICO MATARO','50217668C','53062298X','Franquicia'),('FANH','ALAIN AFFLELOU OPTICO STA. COLOMA','50217668C','53062298X','Franquicia'),('FANI','ALAIN AFFLELOU OPTICO ONDA','77000910S','18924519G','Franquicia'),('FANJ','ALAIN AFFLELOU OPTICO OLOT','50217668C','46624502Y','Franquicia'),('FANK','ALAIN AFFLELOU OPTICO CASTELLÓN ','77000910S','71218533E','Franquicia'),('FANL','ALAIN AFFLELOU OPTICO  CALDAS DE REIS','53110268W','33282234S','Franquicia'),('FANM','ALAIN AFFLELOU OPTICO CULLERA','77000910S','73774883Z','Franquicia'),('FANN','ALAIN AFFLELOU OPTICO ILLESCAS','47488915X','7481335X','Franquicia'),('FANP','ALAIN AFFLELOU OPTICO TÁRREGA','50217668C','43729075A','Franquicia'),('FANQ','ALAIN AFFLELOU OPTICO VIA AUGUSTA','50217668C','18050671H','Franquicia'),('FANR','ALAIN AFFLELOU OPTICO TERRASSA','40331392H','44829780C','Franquicia'),('FANT','C.C. ESPAI GIRONES','50217668C','40369164R','Franquicia'),('FANU','ALAIN AFFLELOU OPTICO ARAVACA','05428323R','53391597H','Franquicia'),('FANV','ALAIN AFFLELOU OPTICO GRAN DE SANT ANDREU','40331392H','44176998R','Franquicia'),('FANW','C.C. CARREFOUR LEÓN','05428323R','12750724F','Franquicia'),('FANX','C.C. MN4','77000910S','73774883Z','Franquicia'),('FANY','ALAIN AFFLELOU OPTICO ANDÚJAR','X2590728P','08866157W','Franquicia'),('FANZ','C.C. PARQUE FERROL','53110268W','32666953F','Franquicia'),('FAOA','ALAIN AFFLELOU OPTICO MÁLAGA','X2590728P','78971583W','Franquicia'),('FAOB','C.C. GRAN VÍA DE ALICANTE','08932984Z','74358854S','Franquicia'),('FAOC','ALAIN AFFLELOU OPTICO MEDINA DEL CAMPO','45673652E','70816017Y','Franquicia'),('FAOD','ALAIN AFFLELOU OPTICO ALGECIRAS','X2590728P','75889611F','Franquicia'),('FAOE','ALAIN AFFLELOU OPTICO C.C. L`ILLA ','50217668C','0007093','Franquicia'),('FAOF','ALAIN AFFLELOU OPTICO CARBALLIÑO','53110268W','77405998G','Franquicia'),('FAOG','ALAIN AFFLELOU OPTICO PRAT','50217668C','46655398J','Franquicia'),('FAOI','ALAIN AFFLELOU OPTICO CEUTA','X2590728P','X0607753R','Franquicia'),('FAOJ','ALAIN AFFLELOU OPTICO VALLEHERMOSO','02542552V','50876686L','Franquicia'),('FAOK','ALAIN AFFLELOU OPTICO SANTUTXU','53110268W','32811534X','Franquicia'),('FAOL','ALAIN AFLLELOU OPTICO SANT CUGAT DEL VALLÉS','50217668C','53077317X','Franquicia'),('FAOM','C.C. CARREFOUR BARICENTRO','50217668C','52147505L','Franquicia'),('FAON','ALAIN AFFLELOU OPTICO SABADELL','50217668C','52147505L','Franquicia'),('FAOO','ALAIN AFFLELOU OPTICO PEDRO ANTONIO','X2590728P','74644644F','Franquicia'),('FAOQ','ALAIN AFFLELOU OPTICO HOSPITALET','40331392H','46609605J','Franquicia'),('FAOR','ALAIN AFFLELOU OPTICO ZAFRA','47488915X','34773423E','Franquicia'),('FAOS','ALAIN AFFLELOU OPTICO CALLE MADRID','08932984Z','26481539Y','Franquicia'),('FAOT','ALAIN AFFLELOU OPTICO MELIDE','53110268W','76500924A','Franquicia');
