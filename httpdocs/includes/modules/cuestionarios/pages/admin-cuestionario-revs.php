...
<div class="row row-top">
	<div class="col-md-9 inset">
		...
		<ul class="nav nav-pills navbar-default">
			...
			<li><a href="#" onClick="Confirma('¿Estas seguro de vaciar los registros?, los datos no podrán ser recuperados.', '?page=admin-cuestionario-revs&act=del&id=<?php echo $id_cuestionario;?>')"><?php echo strTranslate("Delete_items");?></a></li>
