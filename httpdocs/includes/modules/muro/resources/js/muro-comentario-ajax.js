...
jQuery(document).ready(function(){
	...
	function showMuro(){		
		...
		$("#destino").load("includes/modules/muro/pages/muro.php" + "?ms=" + new Date().getTime(), function(){
	...
	function ValidateResponder(){
		...
		if (resultado_ok==true) 
		{
			$.ajax({
				type: 'POST',
				url: 'includes/modules/muro/pages/muro_process.php?t=1',
	...
	function ValidateMuro(){
		...
		if (resultado_ok==true) {
			$.ajax({
				type: 'POST',
				url: 'includes/modules/muro/pages/muro_process.php',
