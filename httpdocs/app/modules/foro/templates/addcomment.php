...
function addForoComment($id_tema){
	...
	<form id="coment-form" name="coment-form" action="" method="post" role="form">
		...
		<textarea cols="45" id="texto-comentario" name="texto-comentario" title="<?php e_strTranslate("Required_field");?>" class="has-warning jtextareaComentar form-control"></textarea>
