				...
				<form id="confirm-form" name="confirm-form" enctype="multipart/form-data" action="" method="post" role="form" class="form-horizontal">
			  		<div class="col-md-12 nopadding">
						...
						<div class="row nopadding">
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-2 col-md-4 control-label" for="username-text"><small><?php echo strTranslate("Username");?></small></label>
							...
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-4 control-label" for="user-empresa"><small><?php echo strTranslate("Group_user");?></small></label>
									<div class="col-sm-8">
						...
						<div class="row nopadding">
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-2 col-md-4 control-label" for="user-nombre"><small><?php echo strTranslate("Name");?></small></label>
									<div class="col-sm-10 col-md-8">
							...
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-4 control-label" for="user-apellidos"><small><?php echo strTranslate("Surname");?></small></label>
									<div class="col-sm-8">
						...
						<div class="row nopadding">
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-2 col-md-4 control-label" for="user-nick"><small><?php echo strTranslate("Nick");?></small></label>
									<div class="col-sm-10 col-md-8">
							...
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-4 control-label" for="user-date"><small><?php echo strTranslate("Born_date");?></small></label>
									<div class="col-sm-8">
						...
						<div class="row nopadding">
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-2 col-md-4 control-label" for="user-pass"><small><?php echo strTranslate("Password");?></small></label>
									<div class="col-sm-10 col-md-8">
							...
							<div class="col-md-6 nopadding">
								<div class="form-group">
									<label class="col-sm-4 control-label" for="user-repass"><small><?php echo strTranslate("Password_re");?></small></label>
									<div class="col-sm-8">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="user-email"><small>Email</small></label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="user-comentarios"><small><?php echo strTranslate("what_do_you_think");?></small></label>
								<div class="col-sm-10">
