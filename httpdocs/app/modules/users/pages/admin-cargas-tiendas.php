	...
	<div class="app-main">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<p>Selecciona un fichero Excel con los datos a cargar. El fichero deberá tener la estructura especificada, puedes descargar el fichero modelo <a href="docs/model_tiendas.xls"><b><?php e_strTranslate("Click_here")?></b></a>.</p>
