...
<div class="row row-top">
	<div class="col-md-9 inset">
		...
		?>
		<p>Selecciona un fichero Excel con los datos a cargar. El fichero deberá tener la estructura especificada, puedes descargar el fichero modelo <a href="docs/model_tiendas.xls"><b><?php echo strTranslate("Click_here")?></b></a>.</p>
		<form id="formImport" name="formImport" enctype="multipart/form-data" method="post" action="?page=admin-cargas-tiendas-process" role="form">
