			...
			<div class="row">
				<div class="col-md-5"> 
					<div class="form-group has-feedback">
						<label for="form-login-user" class="col-sm-4 control-label"><?php e_strTranslate("Username");?></label>
						<div class="col-sm-8">
				...
				<div class="col-md-5">
					<div class="form-group has-feedback">
						<label for="form-login-password" class="col-sm-4 control-label"><?php e_strTranslate("Password");?></label>
						<div class="col-sm-8">
