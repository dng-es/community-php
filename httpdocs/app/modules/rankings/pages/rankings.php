<?php addJavascripts(array(getAsset("users")."js/ranking-empresas.js"));?>
<div class="row row-top">
	<div class="col-md-8 col-lg-9 inset">
		...
		menu::breadcrumb(array(
			...
			array("ItemLabel"=>$ranking_data['nombre_ranking'], "ItemClass"=>"active"),
		));
		...
		<div class="row">
			<div class="col-md-12 container-fade">
				<p><?php echo $ranking_data['descripcion_ranking'];?></p>
				<br />
