...
<div class="row row-top">
	<div class="app-main">
		...
		$categorias = rankingsController::getListCategoryAction(9999, "");
		?>
							...
							<div class="inset">
								<div class="row">
									<div class="col-md-6">
										...
										<input data-alert="<?php e_strTranslate("Required_field");?>" type="text" name="nombre" id ="nombre" class="form-control" value="<?php echo $ranking['nombre_ranking'];?>" />
									</div>
									...
									<div class="col-md-6">
										...
										foreach($categorias['items'] as $categoria):
											echo '<option value="'.$categoria['id_ranking_category'].'" '.($categoria['id_ranking_category']==$ranking['id_ranking_category'] ? 'selected="selected"' : '').'>'.$categoria['ranking_category_name'].'</option>';
										endforeach;?>
										</select>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<textarea name="descripcion" id ="descripcion" class="form-control"><?php echo $ranking['descripcion_ranking'];?></textarea>
