...
$elements = incentivosObjetivosController::getListAction(35, $filtro_perfil." AND NOW() BETWEEN date_ini_objetivo AND date_fin_objetivo ORDER BY id_objetivo ASC");
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>
                                    ...
                                    <?php echo strTranslate("Date_end");?>: <?php echo getDateFormat( $element['date_fin_objetivo'], 'SHORT');?>
                                ...
                                if (count($objetivos)>0):
                                    ...
                                    <p>Total <?php echo strTranslate("APP_Credits");?> conseguidos: <?php echo $total_puntos_user;?></p>
                                    <?php endif; ?>
                                <?php else: ?>
