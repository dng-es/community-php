		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="row">
								...
								<?php foreach($elements['items'] as $element):?>
									...
									<td nowrap="nowrap">
										<button type="button" class="btn btn-default btn-xs" title="<?php e_strTranslate("Delete");?>"
											onClick="Confirma('<?php e_strTranslate("Are_you_sure_to_delete");?>', 'admin-incentives-products-acelerators?pag=<?php echo $elements['pag'].'&f='.$elements['find_reg'].'&act=del&id='.$element['id_acelerador'];?>&ref=<?php echo $element['id_producto'];?>', '<?php e_strTranslate("Are_you_sure");?>', '<?php e_strTranslate("Cancel_text");?>', '<?php e_strTranslate("Confirm_text");?>'); return false"><i class="fa fa-trash icon-table"></i>
										</button>
									</td>
					...
					<div class="col-md-5">
						<div class="panel panel-default">
							<div class="panel-heading"><h4><?php e_strTranslate("Incentives_acelerators_new");?></h4></div>
							<div class="panel-body">
