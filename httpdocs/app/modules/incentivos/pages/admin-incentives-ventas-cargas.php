	...
	<div class="col-md-9 inset">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<p>Selecciona el fichero Excel con los datos a cargar. El fichero deberá tener la estructura especificada, puedes descargar el fichero modelo <a href="docs/model_incentivos.xls"><b><?php echo strTranslate("Click_here")?></b></a>.</p>
