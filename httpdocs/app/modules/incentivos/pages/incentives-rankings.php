...
<div class="row row-top">
	...
	<div class="col-md-4 col-lg-3 nopadding lateral-container">
		<div class="panel-interior">
			...
			<?php if($posicion > 0): ?>
			<br /><br /><h3 class="text-center"><span class="label label-danger">Tu posición: <big><strong class="incentivos-ranking-user2-puntos"><?php echo $posicion;?></strong></big></span></h3>
