			...
			<div class="panel-body">
				<ul class="nav nav-pills navbar-default">
					...
					<div class="pull-right">
						<?php echo SearchForm($elements['reg'],"admin-guides-subcategories-types","searchForm",strTranslate("Search"), strTranslate("Search"),"","navbar-form navbar-left");?>	
					</div>
				</ul>
					...
					<tr>
						<td nowrap="nowrap">
							<button type="button" class="btn btn-default btn-xs" title="<?php e_strTranslate("Delete");?>"
								onClick="Confirma('<?php e_strTranslate("Are_you_sure_to_delete");?>', 'admin-guides-subcategories-types?act=del&e=0&id=<?php echo $element['id_guide_subcategory_type'];?>'); return false"><i class="fa fa-trash icon-table"></i>
							</button>
