...
<div class="row row-top">
	<div class="app-main">
		...
		menu::breadcrumb(array(
			...
			array("ItemLabel"=>strTranslate("Photo_albums"), "ItemUrl"=>"foto-albums"),
		...
		$albums = fotosAlbumController::getListAction(1000, $filtro_canal." AND activo=1 ORDER BY nombre_album ");
		?>
		<section id="photos">
