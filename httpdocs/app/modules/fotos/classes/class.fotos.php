...
class fotos{
	...
	public function cambiarEstado($id, $estado, $seleccion = 0, $tags = ''){
	...
	public function insertFile($fichero, $path_archivo, $canal, $titulo, $id_promocion = 0, $formacion = 0, $tipo_foto = '', $id_album = 0){
		global $fotos_types;
		//SUBIR FICHERO
		...
		if (!(in_array(strtoupper($ext), $fotos_types) && ($tamano_archivo < MAX_SIZE_FOTOS))) return 0;
		else{
