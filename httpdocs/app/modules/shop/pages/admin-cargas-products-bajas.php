	...
	<div class="app-main">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<p>Selecciona un fichero Excel con los productos a cargar. El fichero deberá tener la estructura especificada, puedes descargar el fichero modelo <a href="docs/model_productos_bajas.xls"><b><?php echo strTranslate("Click_here")?></b></a>.</p>
