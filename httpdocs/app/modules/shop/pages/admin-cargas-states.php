	...
	<div class="app-main">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<p>Selecciona un fichero Excel con los pedidos a modificar su estado. El fichero deberá tener la estructura especificada, puedes descargar el fichero modelo <a href="docs/model_orders.xls"><b><?php e_strTranslate("Click_here")?></b></a>.</p>
