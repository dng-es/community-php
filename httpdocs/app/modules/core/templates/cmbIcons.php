<?php
function ComboIcons($seleccionado = "", $filter = ""){
	...
	foreach(array_keys($elements) as $element): ?>
		<option data-content="<i style='width: 25px;display:inline-block' class='text-center fa fa-<?php echo $element;?>'></i> <?php echo $element;?>" value="<?php echo $element;?>" <?php if ($seleccionado == $element){ echo ' selected="selected" ';}?>><?php echo $element;?></option>
	<?php endforeach;
}
