			...
			<div class="col-md-8 col-md-pull-4">
				...
				<form id="contact_form" name="contact_form" method="post" action="" method="post" role="form">
					<div class="form-group">
						...
						<input data-alert="<?php e_strTranslate('Introduce_subject');?>" type="text" name="subject_form" id="subject_form" class="form-control" placeholder="<?php e_strTranslate('Message_subject');?>" />
					</div>
					<div class="form-group">
						<textarea  data-alert="<?php e_strTranslate('Introduce_your_message');?>" cols="56" rows="8" name="body_form" id="body_form" class="jtextarea form-control" placeholder="<?php e_strTranslate('Your_message');?>"></textarea>
					</div>
