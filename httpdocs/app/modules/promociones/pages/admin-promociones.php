		...
		<div class="panel panel-default">
			<div class="panel-body">
				<ul class="nav nav-pills navbar-default">       
					...
					<li><a href="admin-promocion"><?php e_strTranslate("Nuevo reto");?></a></li>
					...
					<table class="table table-striped table-hover">
						...
						<?php foreach($elements['items'] as $element):
							...
							<td nowrap="nowrap">
								...
								<button type="button" class="btn btn-default btn-xs" title="<?php e_strTranslate("Edit");?>" onClick="location.href='admin-promocion?id=<?php echo $element['id_promocion'];?>'; return false"><i class="fa fa-edit icon-table"></i>
								</button>
							</td>
